...
function setUpOutputWatching(captureStderr, forwardOutput) {
    ...
    process.on('exit', (code) => {
        if (code === 0) {
            (0, fs_1.writeFileSync)(process.env.NX_TERMINAL_OUTPUT_PATH, captureStderr ? outWithErr.join('') : out.join(''));
        }
        else {
            (0, fs_1.writeFileSync)(process.env.NX_TERMINAL_OUTPUT_PATH, outWithErr.join(''));
        }
    });
}
